...
impl PedalMapper for Logic {
    ...
    fn on_press(&self, pedal: Self::Pedals) -> Option<Request> {
        use ThreePedals::*;
        Some(match pedal {
            Pedal1 => Request::start(Frontal,High,Video),
            Pedal2 => Request::start(Frontal,Low,Video),
    ...
    fn on_release(&self, pedal: Self::Pedals) -> Option<Request> {
        use ThreePedals::*;
        Some(match pedal {
            Pedal1 => Request::stop(Frontal,High,Video),
            Pedal2 => Request::stop(Frontal,Low,Video),
